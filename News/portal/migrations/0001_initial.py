    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pubDate', models.DateTimeField(auto_now_add=True, verbose_name='дата и время публикации статьи/новости')),
                ('postTitle', models.CharField(max_length=128, verbose_name='название статьи/новости')),
                ('postText', models.TextField(verbose_name='текст статьи/новости')),
